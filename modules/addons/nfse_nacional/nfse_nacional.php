    ...
    return [
        ...
        'fields'      => [
            ...
            'optante_simples' => [
                ...
                'Type'         => 'dropdown',
                'Options'      => 'Optante (ME/EPP),Optante (MEI),Nao Optante',
                'Default'      => 'Optante (ME/EPP)',
                'Description'  => 'Status no Simples Nacional',
            ],
            ...
            'codigo_tributacao_nacional' => [
                ...
                'Size'         => '20',
                'Default'      => '010801',
                'Description'  => 'Codigo de tributacao nacional (cTribNac). Fallback global quando nao configurado por produto.',
            ],
            'codigo_nbs' => [
                'FriendlyName' => 'Codigo NBS',
                'Type'         => 'text',
                'Size'         => '20',
                'Default'      => '115023000',
                'Description'  => 'Nomenclatura Brasileira de Servicos (cNBS). Fallback global quando nao configurado por produto.',
            ],
            'perc_trib_sn' => [
                'FriendlyName' => 'Percentual Total de Tributos SN (%)',
                'Type'         => 'text',
                'Size'         => '8',
                'Default'      => '6.00',
                'Description'  => 'pTotTribSN: percentual total de tributos do Simples Nacional (ex: 6.00)',
            ],
            'tp_ret_issqn' => [
...
function nfse_nacional_activate()
{
    try {
        ...
        return ['status' => 'success', 'description' => 'Addon NFSE Nacional v1.7.2 instalado com sucesso!'];
    } catch (\Exception $e) {
